...
#ifndef MDLSHAPECOSTFUNCTIONPCA_H
#define MDLSHAPECOSTFUNCTIONPCA_H
...
class MDLShapeCostFunctionPCA : public vnl_cost_function
{
public:
	MDLShapeCostFunctionPCA(std::vector<double>& data, const std::vector<double>& initialParam, const size_t numIdentities, const size_t numExpressions, const std::vector<std::vector<double>>& vecCs, const std::vector<std::vector<double>>& matAs
...
private:
	...
	void computeEigenValueDerivative(const size_t mode, const std::vector<double>& modeEigenVectors, const std::vector<double>& modeEigenValues, const size_t eigenValueIndex
												, const size_t iIndex, const size_t jIndex, std::vector<double>& dLambda_dXij);

	void computeEigenValueDerivativeTEST(const size_t mode, const std::vector<double>& modeEigenVectors, const std::vector<double>& modeEigenValues, const size_t eigenValueIndex
																	, const size_t iIndex, const size_t jIndex, std::vector<double>& dLambda_dXij);
	...
	MDLShapeCostFunctionPCA(const MDLShapeCostFunctionPCA& costFunction);

	MDLShapeCostFunctionPCA& operator=(const MDLShapeCostFunctionPCA& costFunction);
